...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/tinygrad-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/tinygrad-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add tinygrad tinygrad-tests
# for installing globally
pixi global install tinygrad tinygrad-tests
```
...
It is possible to list all of the versions of `tinygrad` available on your platform:
...
```
pixi search tinygrad --channel conda-forge
```
